...
namespace unity {
  ...
  void PreviewBasicButton::InitTheme()
  {
    if (prelight_ == NULL)
    {
      prelight_ = new nux::CairoWrapper(GetGeometry(), sigc::bind(sigc::mem_fun(this, &PreviewBasicButton::RedrawTheme), nux::ButtonVisualState::STATE_PRELIGHT));
      active_ = new nux::CairoWrapper(GetGeometry(), sigc::bind(sigc::mem_fun(this, &PreviewBasicButton::RedrawTheme), nux::ButtonVisualState::STATE_PRESSED));
      normal_ = new nux::CairoWrapper(GetGeometry(), sigc::bind(sigc::mem_fun(this, &PreviewBasicButton::RedrawTheme), nux::ButtonVisualState::STATE_NORMAL));
    }
  }
  ...
  void PreviewBasicButton::Draw(nux::GraphicsEngine& GfxContext, bool force_draw)
  {
    ...
    if (state == nux::ButtonVisualState::STATE_PRELIGHT)
      texture = prelight_->GetTexture();
    else if (state == nux::ButtonVisualState::STATE_PRESSED)
    {
