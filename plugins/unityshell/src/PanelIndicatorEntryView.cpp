  ...
  , padding_(padding)
{
  ...
  InputArea::OnMouseDown.connect(sigc::mem_fun(this, &PanelIndicatorEntryView::OnMouseDown));
  InputArea::OnMouseUp.connect(sigc::mem_fun(this, &PanelIndicatorEntryView::OnMouseUp));

  InputArea::SetAcceptMouseWheelEvent(true);
  InputArea::OnMouseWheel.connect(sigc::mem_fun(this, &PanelIndicatorEntryView::OnMouseWheel));
