  ...
  _cairo_text_has_changed(true)
{
  ...
  _tooltip_text = new nux::StaticCairoText(_labelText.c_str(), NUX_TRACKER_LOCATION);
...
{
  g_variant_builder_add(builder, "{sv}", "text", g_variant_new_string(_labelText.c_str()));
