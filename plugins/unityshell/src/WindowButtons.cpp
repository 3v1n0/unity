  ...
  , _opacity(1.0f)
{
  ...
  but->changed.connect(sigc::mem_fun(this, &WindowButtons::OnCloseClicked));
  ...
  AddView(but, 0, nux::eCenter, nux::eFix);
  but->changed.connect(sigc::mem_fun(this, &WindowButtons::OnMinimizeClicked));
  but->mouse_enter.connect(lambda_enter);
  but->mouse_leave.connect(lambda_leave);
  but->mouse_move.connect(lambda_moved);
  ...
  AddView(but, 0, nux::eCenter, nux::eFix);
  but->changed.connect(sigc::mem_fun(this, &WindowButtons::OnRestoreClicked));
  but->mouse_enter.connect(lambda_enter);
  but->mouse_leave.connect(lambda_leave);
  but->mouse_move.connect(lambda_moved);
