...
static gboolean _lambda7_ (ClutterEvent* e, UnityPlacesSearchFieldView* self);
static gboolean __lambda7__clutter_actor_button_press_event (ClutterActor* _sender, ClutterEvent* event, gpointer self);
...
#line 75 "search-field.vala"
	g_signal_connect_object ((ClutterActor*) self->priv->text_field, "button-press-event", (GCallback) __lambda7__clutter_actor_button_press_event, self, 0);
