...
GType unity_places_default_activity_widget_get_type (void) {
	static GType unity_places_default_activity_widget_type_id = 0;
	if (unity_places_default_activity_widget_type_id == 0) {
	...
	return unity_places_default_activity_widget_type_id;
}


#line 106 "default-view.vala"
static void unity_places_default_view_real_allocate (ClutterActor* base, const ClutterActorBox* box, ClutterAllocationFlags flags) {
#line 357 "default-view.c"
...
#line 389 "default-view.c"
}


#line 133 "default-view.vala"
UnityPlacesDefaultView* unity_places_default_view_construct (GType object_type) {
#line 395 "default-view.c"
	UnityPlacesDefaultView * self;
...
GType unity_places_default_view_get_type (void) {
	static GType unity_places_default_view_type_id = 0;
	if (unity_places_default_view_type_id == 0) {
	...
	return unity_places_default_view_type_id;
}
