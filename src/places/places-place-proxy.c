...
#line 76 "places-place-proxy.vala"
static void _unity_places_place_proxy_on_view_changed_dynamic_ViewChanged0_ (DBusGProxy* _sender, const char* view_name, GHashTable* view_properties, gpointer self) {
...
void _dynamic_ViewChanged1_connect (gpointer obj, const char * signal_name, GCallback handler, gpointer data) {
	dbus_g_object_register_marshaller (g_cclosure_user_marshal_VOID__STRING_POINTER, G_TYPE_NONE, G_TYPE_STRING, dbus_g_type_get_map ("GHashTable", G_TYPE_STRING, G_TYPE_STRING), G_TYPE_INVALID);
...
#line 64 "places-place-proxy.vala"
...
#line 66 "places-place-proxy.vala"
		_dynamic_set_active0 (self->priv->service, FALSE, &_inner_error_);
#line 225 "places-place-proxy.c"
		if (_inner_error_ != NULL) {
			goto __catch11_g_error;
			goto __finally11;
		}
...
#line 255 "places-place-proxy.c"
	const char* result;
#line 1047 "glib-2.0.vapi"
	g_return_val_if_fail (self != NULL, NULL);
#line 259 "places-place-proxy.c"
	result = self;
#line 1048 "glib-2.0.vapi"
	return result;
#line 263 "places-place-proxy.c"
}
...
GType unity_places_place_proxy_get_type (void) {
	static GType unity_places_place_proxy_type_id = 0;
	if (unity_places_place_proxy_type_id == 0) {
	...
	return unity_places_place_proxy_type_id;
}
