...
QuicklistView::QuicklistView ()
{
  ...
  for (int i = 0; i < 2; i++)
  {
    ...
    tooltip_text->sigTextColorChanged.connect (sigc::mem_fun (this, &QuicklistView::RecvCairoTextColorChanged));
    _vlayout->AddView(tooltip_text, 1, nux::eCenter, nux::eFull);
