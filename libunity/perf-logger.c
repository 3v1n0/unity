...
UnityProcessInfo* unity_process_info_construct (GType object_type, const char* name) {
#line 133 "perf-logger.c"
	UnityProcessInfo* self;
	char* _tmp0_;
#line 25 "perf-logger.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 138 "perf-logger.c"
...
GType unity_process_info_get_type (void) {
	static GType unity_process_info_type_id = 0;
	if (unity_process_info_type_id == 0) {
	...
	return unity_process_info_type_id;
}
...
UnityTimelineLogger* unity_timeline_logger_get_default (void) {
#line 302 "perf-logger.c"
	UnityTimelineLogger* result;
#line 46 "perf-logger.vala"
	if (unity_timeline_singleton == NULL) {
#line 306 "perf-logger.c"
...
GType unity_timeline_logger_get_type (void) {
	static GType unity_timeline_logger_type_id = 0;
	if (unity_timeline_logger_type_id == 0) {
	...
	return unity_timeline_logger_type_id;
}
