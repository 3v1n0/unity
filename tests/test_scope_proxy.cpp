...
TEST(TestScopeProxy, Search)
{
  ...
  scope_proxy->Search("12:test_search", search_callback, nullptr);
...
TEST(TestScopeProxy, MultiSearch)
{
  ...
  scope_proxy->Search("5:test_search", search_callback, nullptr);
...
TEST(TestScopeProxy, SearchCancelled)
{
  ...
  scope_proxy->Search("12:test_search", search_callback, cancel_search);
...
TEST(TestScopeProxy, SearchCategories)
{
  ...
  scope_proxy->Search("12:test_search", [&] (glib::HintsMap const&, glib::Error const& error) { }, nullptr);
