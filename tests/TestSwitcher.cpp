...
void ThreadWidgetInit(nux::NThread* thread, void* InitData)
{
  ...
  flipping_check->changed.connect (sigc::ptr_fun (OnFlippingChanged));
  ...
  prev_button->changed.connect (sigc::ptr_fun (OnPreviousClicked));
  ...
  next_button->changed.connect (sigc::ptr_fun (OnNextClicked));
  ...
  detail_button->changed.connect (sigc::ptr_fun (OnDetailClicked));
