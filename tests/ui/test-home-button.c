...
enum  {
	...
	UNITY_TESTS_UI_HOME_BUTTON_SUITE_IS_STARTING,
...
static gboolean unity_tests_ui_home_button_suite_real_get_is_starting (UnityShell* base) {
	gboolean result;
	UnityTestsUIHomeButtonSuite* self;
	self = (UnityTestsUIHomeButtonSuite*) base;
...
static void unity_tests_ui_home_button_suite_real_set_is_starting (UnityShell* base, gboolean value) {
	UnityTestsUIHomeButtonSuite* self;
	self = (UnityTestsUIHomeButtonSuite*) base;
...
static void unity_tests_ui_home_button_suite_class_init (UnityTestsUIHomeButtonSuiteClass * klass) {
	...
	g_object_class_override_property (G_OBJECT_CLASS (klass), UNITY_TESTS_UI_HOME_BUTTON_SUITE_IS_STARTING, "is-starting");
...
static void unity_tests_ui_home_button_suite_unity_shell_interface_init (UnityShellIface * iface) {
	...
	iface->get_is_starting = unity_tests_ui_home_button_suite_real_get_is_starting;
	iface->set_is_starting = unity_tests_ui_home_button_suite_real_set_is_starting;
...
static void unity_tests_ui_home_button_suite_get_property (GObject * object, guint property_id, GValue * value, GParamSpec * pspec) {
	...
	switch (property_id) {
		...
		break;
		case UNITY_TESTS_UI_HOME_BUTTON_SUITE_IS_STARTING:
