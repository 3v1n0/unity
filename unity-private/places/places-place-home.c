/* places-place-home.c generated by valac 0.9.7, the Vala compiler
...
static void unity_places_place_home_entry_real_set_mimetypes (UnityPlacesPlaceEntry* base, char** value, int value_length1) {
	...
	char** _tmp1_;
	self = (UnityPlacesPlaceHomeEntry*) base;
	self->priv->_mimetypes = (_tmp1_ = (_tmp0_ = value, (_tmp0_ == NULL) ? ((gpointer) _tmp0_) : _vala_array_dup3 (_tmp0_, value_length1)), self->priv->_mimetypes = (_vala_array_free (self->priv->_mimetypes, self->priv->_mimetypes_length1, (GDestroyNotify) g_free), NULL), self->priv->_mimetypes_length1 = value_length1, self->priv->__mimetypes_size_ = self->priv->_mimetypes_length1, _tmp1_);
