/* places-place-home.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda30_ (DeeModelIter* it, Block3Data* _data3_);
static void __lambda30__dee_model_row_added (DeeModel* _sender, DeeModelIter* iter, gpointer self);
static void _lambda31_ (DeeModelIter* it, Block3Data* _data3_);
static void __lambda31__dee_model_row_removed (DeeModel* _sender, DeeModelIter* iter, gpointer self);
...
static void unity_places_place_home_entry_on_place_added (UnityPlacesPlaceHomeEntry* self, UnityPlacesPlace* place) {
	...
	g_return_if_fail (place != NULL);
	{
		...
		while (TRUE) {
			...
			g_signal_connect_data (unity_places_place_entry_get_global_results_model (_data3_->entry), "row-added", (GCallback) __lambda30__dee_model_row_added, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
			g_signal_connect_data (unity_places_place_entry_get_global_results_model (_data3_->entry), "row-removed", (GCallback) __lambda31__dee_model_row_removed, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
			block3_data_unref (_data3_);
		}
...
static void unity_places_place_home_entry_real_set_search (UnityPlacesPlaceEntry* base, const char* search, GHashTable* hints) {
	...
	old_renderer = g_strdup (unity_places_place_entry_get_entry_renderer_name ((UnityPlacesPlaceEntry*) self));
