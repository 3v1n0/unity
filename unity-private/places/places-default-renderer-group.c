...
static GObject * unity_places_expander_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	{
		UnityCairoCanvas* _tmp18_;
		self->priv->arrow = (_tmp18_ = g_object_ref_sink (unity_cairo_canvas_new (_unity_places_expander_paint_arrow_unity_cairo_canvas_cairo_canvas_paint, self)), _g_object_unref0 (self->priv->arrow), _tmp18_);
...
static GObject * unity_places_more_results_button_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	{
		CtkVBox* box;
		CtkPadding _tmp19_ = {0};
		CtkPadding _tmp20_;
		UnityCairoCanvas* _tmp21_;
		CtkText* _tmp22_;
		box = g_object_ref_sink ((CtkVBox*) ctk_vbox_new ((guint) 0));
		ctk_actor_set_padding ((CtkActor*) box, (_tmp20_ = (_tmp19_.top = (float) 4, _tmp19_.right = (float) 8, _tmp19_.bottom = (float) 4, _tmp19_.left = (float) 8, _tmp19_), &_tmp20_));
		clutter_container_add_actor ((ClutterContainer*) self, (ClutterActor*) box);
		clutter_actor_show ((ClutterActor*) box);
		self->priv->bg = (_tmp21_ = g_object_ref_sink (unity_cairo_canvas_new (_unity_places_more_results_button_paint_bg_unity_cairo_canvas_cairo_canvas_paint, self)), _g_object_unref0 (self->priv->bg), _tmp21_);
		ctk_actor_set_background ((CtkActor*) self, (ClutterActor*) self->priv->bg);
		clutter_actor_show ((ClutterActor*) self->priv->bg);
		self->priv->text = (_tmp22_ = g_object_ref_sink ((CtkText*) ctk_text_new ("")), _g_object_unref0 (self->priv->text), _tmp22_);
