/* places-place-search-bar.c generated by valac 0.9.5, the Vala compiler
...
static gboolean _lambda35_ (Block4Data* _data4_);
...
void unity_places_place_search_bar_set_active_entry_view (UnityPlacesPlaceSearchBar* self, UnityPlacesPlaceEntry* entry, gint x, guint section) {
	...
	if (_data4_->section != 0) {
		g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, __lambda35__gsource_func, block4_data_ref (_data4_), block4_data_unref);
	}
...
static GObject * unity_places_place_search_bar_background_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_inner_error_ = NULL;
	{
		...
		__catch27_g_error:
		{
			...
			_inner_error_ = NULL;
			{
				g_warning ("places-place-search-bar.vala:199: Unable to load dash background");
				_g_error_free0 (e);
			}
		}
		__finally27:
