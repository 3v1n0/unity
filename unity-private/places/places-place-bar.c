/* places-place-bar.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda59_ (UnityPlacesPlace* p, UnityPlacesPlaceBar* self);
static void __lambda59__unity_places_place_model_place_added (UnityPlacesPlaceModel* _sender, UnityPlacesPlace* place, gpointer self);
...
static GObject * unity_places_place_bar_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = UNITY_PLACES_PLACE_BAR (obj);
	{
		...
		g_signal_connect_object (self->priv->_model, "place-added", (GCallback) __lambda59__unity_places_place_model_place_added, self, 0);
	}
	return obj;
}
