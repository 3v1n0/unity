/* places-place-search-entry.c generated by valac 0.9.5, the Vala compiler
...
static gboolean _lambda34_ (UnityPlacesPlaceSearchEntry* self);
...
static void unity_places_place_search_entry_on_text_changed (UnityPlacesPlaceSearchEntry* self) {
	...
	self->priv->live_search_timeout = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) UNITY_PLACES_PLACE_SEARCH_ENTRY_LIVE_SEARCH_TIMEOUT, __lambda34__gsource_func, g_object_ref (self), g_object_unref);
}
