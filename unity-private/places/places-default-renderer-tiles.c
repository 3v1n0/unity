/* places-default-renderer-tiles.c generated by valac 0.9.7, the Vala compiler
...
static void unity_places_file_info_tile_set_icon (UnityPlacesFileInfoTile* self) {
	...
	if (_tmp0_) {
		unity_pixbuf_cache_set_image_from_gicon_string (cache, self->priv->icon, unity_places_tile_get_icon_hint ((UnityPlacesTile*) self), UNITY_PLACES_FILE_INFO_TILE_ICON_HEIGHT, NULL, NULL);
	} else {
		...
		if (_tmp1_) {
			...
			unity_pixbuf_cache_set_image_from_gicon_string (cache, self->priv->icon, g_icon_to_string (icon), UNITY_PLACES_FILE_INFO_TILE_ICON_HEIGHT, NULL, NULL);
			_g_object_unref0 (icon);
		} else {
			unity_pixbuf_cache_set_image_from_icon_name (cache, self->priv->icon, UNITY_PLACES_TILE_DEFAULT_ICON, UNITY_PLACES_FILE_INFO_TILE_ICON_HEIGHT, NULL, NULL);
		}
	}
...
static void unity_places_showcase_tile_set_icon (UnityPlacesShowcaseTile* self) {
	...
	if (_tmp0_) {
		unity_pixbuf_cache_set_image_from_gicon_string (cache, ctk_button_get_image ((CtkButton*) self), unity_places_tile_get_icon_hint ((UnityPlacesTile*) self), UNITY_PLACES_SHOWCASE_TILE_ICON_SIZE, NULL, NULL);
	} else {
		gboolean _tmp1_ = FALSE;
		if (unity_places_tile_get_mimetype ((UnityPlacesTile*) self) != NULL) {
			_tmp1_ = _vala_strcmp0 (unity_places_tile_get_mimetype ((UnityPlacesTile*) self), "") != 0;
		...
		if (_tmp1_) {
			GIcon* icon;
			icon = g_content_type_get_icon (unity_places_tile_get_mimetype ((UnityPlacesTile*) self));
			unity_pixbuf_cache_set_image_from_gicon_string (cache, ctk_button_get_image ((CtkButton*) self), g_icon_to_string (icon), UNITY_PLACES_SHOWCASE_TILE_ICON_SIZE, NULL, NULL);
			_g_object_unref0 (icon);
		} else {
			unity_pixbuf_cache_set_image_from_icon_name (cache, ctk_button_get_image ((CtkButton*) self), UNITY_PLACES_TILE_DEFAULT_ICON, UNITY_PLACES_SHOWCASE_TILE_ICON_SIZE, NULL, NULL);
		}
	}
	_g_object_unref0 (cache);
}
...
static void unity_places_default_tile_set_icon (UnityPlacesDefaultTile* self) {
	...
	if (_tmp0_) {
		unity_pixbuf_cache_set_image_from_gicon_string (cache, ctk_button_get_image ((CtkButton*) self), unity_places_tile_get_icon_hint ((UnityPlacesTile*) self), UNITY_PLACES_DEFAULT_TILE_ICON_SIZE, NULL, NULL);
	} else {
		gboolean _tmp1_ = FALSE;
		if (unity_places_tile_get_mimetype ((UnityPlacesTile*) self) != NULL) {
			_tmp1_ = _vala_strcmp0 (unity_places_tile_get_mimetype ((UnityPlacesTile*) self), "") != 0;
		...
		if (_tmp1_) {
			GIcon* icon;
			icon = g_content_type_get_icon (unity_places_tile_get_mimetype ((UnityPlacesTile*) self));
			unity_pixbuf_cache_set_image_from_gicon_string (cache, ctk_button_get_image ((CtkButton*) self), g_icon_to_string (icon), UNITY_PLACES_DEFAULT_TILE_ICON_SIZE, NULL, NULL);
			_g_object_unref0 (icon);
		} else {
			unity_pixbuf_cache_set_image_from_icon_name (cache, ctk_button_get_image ((CtkButton*) self), UNITY_PLACES_TILE_DEFAULT_ICON, UNITY_PLACES_DEFAULT_TILE_ICON_SIZE, NULL, NULL);
		}
	}
	_g_object_unref0 (cache);
}
