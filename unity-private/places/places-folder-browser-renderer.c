/* places-folder-browser-renderer.c generated by valac, the Vala compiler
...
static void _lambda26_ (const char* u, const char* m, UnityPlacesFolderBrowserRenderer* self);
static void __lambda26__unity_places_default_renderer_group_activated (UnityPlacesDefaultRendererGroup* _sender, const char* uri, const char* mimetype, gpointer self);
...
static void unity_places_folder_browser_renderer_real_set_models (UnityPlaceRenderer* base, DeeModel* model, DeeModel* results, GeeHashMap* hints) {
	...
	g_signal_connect_object (group, "activated", (GCallback) __lambda26__unity_places_default_renderer_group_activated, self, 0);
