/* places-place-home-renderer.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda43_ (UnityPlacesHomeRenderer* self);
static void __lambda43__ctk_button_clicked (CtkButton* _sender, gpointer self);
static void _lambda44_ (UnityPlacesHomeRenderer* self);
static void __lambda44__ctk_button_clicked (CtkButton* _sender, gpointer self);
static void _lambda45_ (UnityPlacesHomeRenderer* self);
static void __lambda45__ctk_button_clicked (CtkButton* _sender, gpointer self);
static void _lambda46_ (UnityPlacesHomeRenderer* self);
static void __lambda46__ctk_button_clicked (CtkButton* _sender, gpointer self);
...
static GObject * unity_places_home_renderer_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = UNITY_PLACES_HOME_RENDERER (obj);
	{
		...
		g_signal_connect_object ((CtkButton*) icon, "clicked", (GCallback) __lambda43__ctk_button_clicked, self, 0);
		...
		clutter_container_add_actor ((ClutterContainer*) self->priv->icon_view, (ClutterActor*) icon);
		clutter_actor_show ((ClutterActor*) icon);
		g_signal_connect_object ((CtkButton*) icon, "clicked", (GCallback) __lambda44__ctk_button_clicked, self, 0);
		...
		clutter_container_add_actor ((ClutterContainer*) self->priv->icon_view, (ClutterActor*) icon);
		clutter_actor_show ((ClutterActor*) icon);
		g_signal_connect_object ((CtkButton*) icon, "clicked", (GCallback) __lambda45__ctk_button_clicked, self, 0);
		...
		clutter_container_add_actor ((ClutterContainer*) self->priv->icon_view, (ClutterActor*) icon);
		clutter_actor_show ((ClutterActor*) icon);
		g_signal_connect_object ((CtkButton*) icon, "clicked", (GCallback) __lambda46__ctk_button_clicked, self, 0);
