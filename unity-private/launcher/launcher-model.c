...
void unity_quicklauncher_models_launcher_model_refresh (UnityQuicklauncherModelsLauncherModel* self) {
	UNITY_QUICKLAUNCHER_MODELS_LAUNCHER_MODEL_GET_INTERFACE (self)->refresh (self);
}
...
GType unity_quicklauncher_models_launcher_model_get_type (void) {
	static volatile gsize unity_quicklauncher_models_launcher_model_type_id__volatile = 0;
	if (g_once_init_enter (&unity_quicklauncher_models_launcher_model_type_id__volatile)) {
		...
		GType unity_quicklauncher_models_launcher_model_type_id;
		...
		g_once_init_leave (&unity_quicklauncher_models_launcher_model_type_id__volatile, unity_quicklauncher_models_launcher_model_type_id);
	}
	return unity_quicklauncher_models_launcher_model_type_id__volatile;
}
...
GType unity_quicklauncher_models_shortcut_item_get_type (void) {
	static volatile gsize unity_quicklauncher_models_shortcut_item_type_id__volatile = 0;
	if (g_once_init_enter (&unity_quicklauncher_models_shortcut_item_type_id__volatile)) {
		...
		GType unity_quicklauncher_models_shortcut_item_type_id;
		...
		g_once_init_leave (&unity_quicklauncher_models_shortcut_item_type_id__volatile, unity_quicklauncher_models_shortcut_item_type_id);
	}
	return unity_quicklauncher_models_shortcut_item_type_id__volatile;
}
