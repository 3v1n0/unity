/* scroller-view.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda66_ (UnityLauncherScrollerView* self);
...
static void _lambda67_ (Block12Data* _data12_);
static void __lambda67__clutter_animation_completed (ClutterAnimation* _sender, gpointer self);
...
static gboolean _lambda68_ (UnityLauncherScrollerView* self);
...
static void _lambda69_ (UnityLauncherScrollerView* self);
static void __lambda69__clutter_timeline_started (ClutterTimeline* _sender, gpointer self);
static gboolean _lambda71_ (UnityLauncherScrollerView* self);
static gboolean __lambda71__gsource_func (gpointer self);
static void _lambda70_ (UnityLauncherScrollerView* self);
static void __lambda70__clutter_timeline_completed (ClutterTimeline* _sender, gpointer self);
static void _lambda72_ (UnityLauncherScrollerView* self);
static void __lambda72__unity_drag_controller_drag_start (UnityDragController* _sender, UnityDragModel* model, gpointer self);
static void _lambda73_ (UnityLauncherScrollerView* self);
static void __lambda73__unity_drag_controller_drag_drop (UnityDragController* _sender, UnityDragModel* model, float x, float y, gpointer self);
static gboolean _lambda74_ (UnityLauncherScrollerView* self);
static gboolean __lambda74__gsource_func (gpointer self);
...
static void unity_launcher_scroller_view_draw_keyboard_indicator_cairo (UnityLauncherScrollerView* self, cairo_t* cr, const char* text) {
	...
	w_diff = extents.width - real_extents.width;
	h_diff = extents.height - real_extents.height;
	w = w + extents.width;
	h = h + extents.height;
...
static void unity_launcher_scroller_view_model_child_added (UnityLauncherScrollerView* self, UnityLauncherScrollerChild* child) {
	...
	clutter_actor_queue_relayout ((ClutterActor*) self);
	g_signal_connect_object ((GObject*) child, "notify::position", (GCallback) __lambda66__g_object_notify, self, 0);
...
static void unity_launcher_scroller_view_model_child_removed (UnityLauncherScrollerView* self, UnityLauncherScrollerChild* child) {
	...
	g_signal_connect_data (anim, "completed", (GCallback) __lambda67__clutter_animation_completed, block12_data_ref (_data12_), (GClosureNotify) block12_data_unref, 0);
	unity_launcher_scroller_view_order_children (self, FALSE);
	clutter_actor_queue_relayout ((ClutterActor*) self);
	_g_object_unref0 (anim);
...
static void unity_launcher_scroller_view_on_auto_scrolling_state_change (UnityLauncherScrollerView* self) {
	...
	if (_tmp0_) {
		g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 33, __lambda68__gsource_func, g_object_ref (self), g_object_unref);
	}
}
			...
			while (TRUE) {
				...
				if (immediate) {
					...
					if (do_new_position) {
						...
						clutter_actor_animate ((ClutterActor*) child, (gulong) CLUTTER_EASE_OUT_QUAD, (guint) 300, "position", (_tmp9_ = (UnityLauncherChildTransition*) gee_abstract_list_get ((GeeAbstractList*) transitions, index))->position, NULL);
...
static void unity_launcher_scroller_view_real_allocate (ClutterActor* base, const ClutterActorBox* box, ClutterAllocationFlags flags) {
	...
	index = (guint) 0;
	{
		...
		while (TRUE) {
			...
			if (_tmp5_) {
				ClutterCairoTexture* keyboard_indicator;
				ClutterCairoTexture* _tmp6_;
				keyboard_indicator = NULL;
				keyboard_indicator = (_tmp6_ = (ClutterCairoTexture*) gee_abstract_list_get ((GeeAbstractList*) self->priv->keyboard_indicators, (gint) index), _g_object_unref0 (keyboard_indicator), _tmp6_);
				if (CLUTTER_IS_ACTOR (keyboard_indicator)) {
					...
					child_box.x1 = ((clutter_actor_box_get_width (box) - (ctk_actor_get_padding ((CtkActor*) self, &_tmp7_), _tmp7_.right)) - surface_width) - 6;
					child_box.x2 = child_box.x1 + clutter_actor_get_width ((ClutterActor*) keyboard_indicator);
					child_box.y1 = (unity_launcher_scroller_child_get_position (child) + (ctk_actor_get_padding ((CtkActor*) self, &_tmp8_), _tmp8_.top)) + ((clutter_actor_box_get_height (&child_box) * 0.5f) - (surface_height * 0.5f));
...
static void _lambda70_ (UnityLauncherScrollerView* self) {
	g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 0, __lambda71__gsource_func, g_object_ref (self), g_object_unref);
}
...
static GObject * unity_launcher_scroller_view_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = UNITY_LAUNCHER_SCROLLER_VIEW (obj);
	{
		...
		self->fling_timeline = (_tmp3_ = clutter_timeline_new ((guint) 1000), _g_object_unref0 (self->fling_timeline), _tmp3_);
		...
		g_signal_connect_object (self->fling_timeline, "started", (GCallback) __lambda69__clutter_timeline_started, self, 0);
		g_signal_connect_object (self->fling_timeline, "completed", (GCallback) __lambda70__clutter_timeline_completed, self, 0);
		drag_controller = _g_object_ref0 (unity_drag_controller_get_default ());
		g_signal_connect_object (drag_controller, "drag-start", (GCallback) __lambda72__unity_drag_controller_drag_start, self, 0);
		g_signal_connect_object (drag_controller, "drag-drop", (GCallback) __lambda73__unity_drag_controller_drag_drop, self, 0);
		clutter_actor_set_reactive ((ClutterActor*) self, TRUE);
		self->priv->child_refs = (_tmp4_ = gee_array_list_new (UNITY_LAUNCHER_TYPE_SCROLLER_CHILD, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL), _g_object_unref0 (self->priv->child_refs), _tmp4_);
		unity_launcher_scroller_view_order_children (self, TRUE);
		clutter_actor_queue_relayout ((ClutterActor*) self);
		g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, __lambda74__gsource_func, g_object_ref (self), g_object_unref);
		_g_object_unref0 (drag_controller);
	}
	return obj;
}
