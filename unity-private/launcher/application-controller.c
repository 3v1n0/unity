/* application-controller.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda61_ (Block6Data* _data6_);
static void __lambda61__dbusmenu_menuitem_realized (DbusmenuMenuitem* _sender, gpointer self);
static Block6Data* block6_data_ref (Block6Data* _data6_);
static void block6_data_unref (Block6Data* _data6_);
static void _lambda60_ (Block5Data* _data5_);
static void __lambda60__dbusmenu_client_layout_updated (DbusmenuClient* _sender, gpointer self);
static Block5Data* block5_data_ref (Block5Data* _data5_);
static void block5_data_unref (Block5Data* _data5_);
static void _g_list_free_g_object_unref (GList* self);
static void _lambda62_ (guint timestamp, Block8Data* _data8_);
...
static void _lambda63_ (guint timestamp, UnityLauncherApplicationController* self);
static void __lambda63__dbusmenu_menuitem_item_activated (DbusmenuMenuitem* _sender, guint object, gpointer self);
static void _lambda64_ (guint timestamp, UnityLauncherApplicationController* self);
static void __lambda64__dbusmenu_menuitem_item_activated (DbusmenuMenuitem* _sender, guint object, gpointer self);
...
static void _lambda65_ (gboolean value, UnityLauncherApplicationController* self);
static void __lambda65__bamf_view_user_visible_changed (BamfView* _sender, gboolean object, gpointer self);
...
static void _lambda60_ (Block5Data* _data5_) {
	...
	_data6_->menu = dbusmenu_client_get_root (self->priv->menu_client);
	self->priv->cached_menu = (_tmp0_ = _g_object_ref0 (_data6_->menu), _g_object_unref0 (self->priv->cached_menu), _tmp0_);
	if (DBUSMENU_IS_MENUITEM (_data6_->menu) == FALSE) {
		char* _tmp1_;
	...
	menu_items = dbusmenu_menuitem_get_children (_data6_->menu);
	self->priv->menu_items_realized_counter = (gint) g_list_length (menu_items);
	{
		...
		for (menuitem_it = menuitem_collection; menuitem_it != NULL; menuitem_it = menuitem_it->next) {
			...
			{
				g_signal_connect_data (menuitem, "realized", (GCallback) __lambda61__dbusmenu_menuitem_realized, block6_data_ref (_data6_), (GClosureNotify) block6_data_unref, 0);
...
static void block5_data_unref (Block5Data* _data5_) {
	if (g_atomic_int_dec_and_test (&_data5_->_ref_count_)) {
		block7_data_unref (_data5_->_data7_);
...
static void _lambda62_ (guint timestamp, Block8Data* _data8_) {
	...
	self = _data7_->self;
	indicator_desktop_shortcuts_nick_exec (_data7_->shortcuts, _data8_->local_nick);
}


static void __lambda62__dbusmenu_menuitem_item_activated (DbusmenuMenuitem* _sender, guint object, gpointer self) {
	_lambda62_ (object, self);
}
			...
			for (view_it = view_collection; view_it != NULL; view_it = view_it->next) {
				...
				view = _g_object_ref0 ((BamfView*) view_it->data);
				{
					if (BAMF_IS_INDICATOR (view)) {
						...
						_data5_->_data7_ = block7_data_ref (_data7_);
						...
						g_signal_connect_data (self->priv->menu_client, "layout-updated", (GCallback) __lambda60__dbusmenu_client_layout_updated, block5_data_ref (_data5_), (GClosureNotify) block5_data_unref, 0);
	...
	dbusmenu_menuitem_set_root (root, TRUE);
	{
		...
		for (nick_it = 0; nick_it < nicks_length1; nick_it = nick_it + 1) {
			...
			nick = g_strdup (nick_collection[nick_it]);
			{
				...
				name = indicator_desktop_shortcuts_nick_get_name (_data7_->shortcuts, _data8_->local_nick);
				...
				g_signal_connect_data (shortcut_item, "item-activated", (GCallback) __lambda62__dbusmenu_menuitem_item_activated, block8_data_ref (_data8_), (GClosureNotify) block8_data_unref, 0);
...
static void unity_launcher_application_controller_real_get_menu_navigation (UnityLauncherScrollerChildController* base, UnityLauncherScrollerChildControllermenu_cb callback, void* callback_target) {
	...
	if (_tmp0_) {
		...
		g_signal_connect_object (pinning_item, "item-activated", (GCallback) __lambda63__dbusmenu_menuitem_item_activated, self, 0);
	...
	if (BAMF_IS_APPLICATION (self->priv->app)) {
		...
		g_signal_connect_object (app_item, "item-activated", (GCallback) __lambda64__dbusmenu_menuitem_item_activated, self, 0);
...
void unity_launcher_application_controller_attach_application (UnityLauncherApplicationController* self, BamfApplication* application) {
	...
	g_signal_connect_object ((BamfView*) self->priv->app, "user-visible-changed", (GCallback) __lambda65__bamf_view_user_visible_changed, self, 0);
