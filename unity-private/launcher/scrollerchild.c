/* scrollerchild.c generated by valac 0.9.5, the Vala compiler
...
static void unity_launcher_scroller_child_load_textures (UnityLauncherScrollerChild* self) {
	...
	__catch48_g_error:
	{
		...
		_inner_error_ = NULL;
		{
			g_warning ("scrollerchild.vala:145: Unable to load asset %s: %s", UNITY_LAUNCHER_HONEYCOMB_MASK_FILE, e->message);
			_g_error_free0 (e);
		}
	}
	__finally48:
