/* quicklist-controller.c generated by valac 0.9.5, the Vala compiler
...
static void _lambda19_ (UnityLauncherApplicationQuicklistController* self);
static void __lambda19__clutter_actor_destroy (ClutterActor* _sender, gpointer self);
...
static void __lambda20__ctk_menu_item_activated (CtkMenuItem* _sender, gpointer self);
...
static void _lambda21_ (DbusmenuMenuitem* top_menu, UnityLauncherApplicationQuicklistController* self);
static void __lambda21__unitylauncherscrollerchildcontrollermenu_cb (DbusmenuMenuitem* menu, gpointer self);
...
static void _lambda28_ (DbusmenuMenuitem* bottom_menu, UnityLauncherApplicationQuicklistController* self);
static void __lambda28__unitylauncherscrollerchildcontrollermenu_cb (DbusmenuMenuitem* menu, gpointer self);
...
static void _lambda22_ (Block9Data* _data9_);
static void __lambda22__ctk_check_menu_item_toggled (CtkCheckMenuItem* _sender, gpointer self);
static void _lambda23_ (const char* property_name, void* value, Block9Data* _data9_);
static void __lambda23__dbusmenu_menuitem_property_changed (DbusmenuMenuitem* _sender, const char* property_name, void* value, gpointer self);
...
static void _lambda25_ (Block9Data* _data9_);
static void __lambda25__ctk_menu_item_activated (CtkMenuItem* _sender, gpointer self);
static gboolean _lambda27_ (UnityLauncherApplicationQuicklistController* self);
...
static void __lambda29__unity_drag_controller_drag_start (UnityDragController* _sender, UnityDragModel* model, gpointer self);
...
static void unity_launcher_application_quicklist_controller_new_menu (UnityLauncherApplicationQuicklistController* self) {
	...
	if (UNITY_IS_SHELL (unity_global_shell)) {
		g_signal_connect_object ((ClutterActor*) ((UnityLauncherQuicklistController*) self)->menu, "destroy", (GCallback) __lambda19__clutter_actor_destroy, self, 0);
...
"oes not exist");
	...
	if (unity_launcher_quicklist_controller_get_state ((UnityLauncherQuicklistController*) self) == UNITY_LAUNCHER_QUICKLIST_CONTROLLER_STATE_LABEL) {
		...
		g_signal_connect_object ((CtkMenuItem*) menuitem, "activated", (GCallback) __lambda20__ctk_menu_item_activated, self, 0);
		...
		if (unity_launcher_quicklist_controller_get_state ((UnityLauncherQuicklistController*) self) == UNITY_LAUNCHER_QUICKLIST_CONTROLLER_STATE_MENU) {
			...
			unity_launcher_scroller_child_controller_get_menu_actions (unity_launcher_quicklist_controller_get_attached_controller ((UnityLauncherQuicklistController*) self), __lambda21__unitylauncherscrollerchildcontrollermenu_cb, self);
			unity_launcher_scroller_child_controller_get_menu_navigation (unity_launcher_quicklist_controller_get_attached_controller ((UnityLauncherQuicklistController*) self), __lambda28__unitylauncherscrollerchildcontrollermenu_cb, self);
		}
	}
}
...
static void __lambda23__dbusmenu_menuitem_property_changed (DbusmenuMenuitem* _sender, const char* property_name, void* value, gpointer self) {
	_lambda23_ (property_name, value, self);
}
...
static void _lambda26_ (UnityLauncherApplicationQuicklistController* self) {
	g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, __lambda27__gsource_func, g_object_ref (self), g_object_unref);
}
...
static CtkMenuItem* unity_launcher_application_quicklist_controller_menu_item_from_dbusmenuitem (UnityLauncherApplicationQuicklistController* self, DbusmenuMenuitem* dbusmenuitem) {
	...
	if (_vala_strcmp0 (type, "label") == 0) {
		...
		if (_tmp6_) {
			...
			g_signal_connect_data ((_tmp10_ = _data9_->menuitem, CTK_IS_CHECK_MENU_ITEM (_tmp10_) ? ((CtkCheckMenuItem*) _tmp10_) : NULL), "toggled", (GCallback) __lambda22__ctk_check_menu_item_toggled, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
			g_signal_connect_data (_data9_->dbusmenuitem, "property-changed", (GCallback) __lambda23__dbusmenu_menuitem_property_changed, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
		} else {
			if (_vala_strcmp0 (type, "seperator") == 0) {
				...
				g_warning ("quicklist-controller.vala:337: not a menu item we understand, %s", dbusmenu_menuitem_property_get (_data9_->dbusmenuitem, "type"));
				result = NULL;
				_g_free0 (check_type);
				_g_free0 (type);
				_g_free0 (label);
	...
	g_signal_connect_data (_data9_->menuitem, "activated", (GCallback) __lambda25__ctk_menu_item_activated, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
	g_signal_connect_object (_data9_->menuitem, "activated", (GCallback) __lambda26__ctk_menu_item_activated, self, 0);
...
static GObject * unity_launcher_application_quicklist_controller_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	self = UNITY_LAUNCHER_APPLICATION_QUICKLIST_CONTROLLER (obj);
	{
		...
		drag_controller = _g_object_ref0 (unity_drag_controller_get_default ());
		g_signal_connect_object (drag_controller, "drag-start", (GCallback) __lambda29__unity_drag_controller_drag_start, self, 0);
		_g_object_unref0 (drag_controller);
	}
	return obj;
}
