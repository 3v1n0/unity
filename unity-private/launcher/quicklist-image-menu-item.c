/* quicklist-image-menu-item.c generated by valac 0.9.5, the Vala compiler
...
struct _UnityLauncherQuicklistImageMenuItemPrivate {
...
static gpointer unity_launcher_quicklist_image_menu_item_parent_class = NULL;

GType unity_launcher_quicklist_image_menu_item_get_type (void) G_GNUC_CONST;
#define UNITY_LAUNCHER_QUICKLIST_IMAGE_MENU_ITEM_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), UNITY_LAUNCHER_TYPE_QUICKLIST_IMAGE_MENU_ITEM, UnityLauncherQuicklistImageMenuItemPrivate))
enum  {
...
static GObject * unity_launcher_quicklist_image_menu_item_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties);
static void unity_launcher_quicklist_image_menu_item_finalize (GObject* obj);
...
static gboolean __unity_launcher_quicklist_image_menu_item_update_item_background_gsource_func (gpointer self) {
	gboolean result;
	result = _unity_launcher_quicklist_image_menu_item_update_item_background (self);
	return result;
}
...
static void unity_launcher_quicklist_image_menu_item_real_allocate (ClutterActor* base, const ClutterActorBox* box, ClutterAllocationFlags flags) {
	...
	new_width = 0;
	new_height = 0;
	CLUTTER_ACTOR_CLASS (unity_launcher_quicklist_image_menu_item_parent_class)->allocate ((ClutterActor*) CTK_IMAGE_MENU_ITEM (self), box, flags);
	...
	g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 0, __unity_launcher_quicklist_image_menu_item_update_item_background_gsource_func, g_object_ref (self), g_object_unref);
}
...
static void __unity_launcher_quicklist_image_menu_item_on_label_changed_g_object_notify (GObject* _sender, GParamSpec* pspec, gpointer self) {
	_unity_launcher_quicklist_image_menu_item_on_label_changed (self);
}


static gboolean __unity_launcher_quicklist_image_menu_item_on_enter_clutter_actor_enter_event (ClutterActor* _sender, ClutterEvent* event, gpointer self) {
	gboolean result;
	result = _unity_launcher_quicklist_image_menu_item_on_enter (self, event);
	return result;
}
...
static gboolean __unity_launcher_quicklist_image_menu_item_on_leave_clutter_actor_leave_event (ClutterActor* _sender, ClutterEvent* event, gpointer self) {
	gboolean result;
	result = _unity_launcher_quicklist_image_menu_item_on_leave (self, event);
	return result;
}
...
static gboolean __unity_launcher_quicklist_image_menu_item_on_mouse_down_clutter_actor_button_press_event (ClutterActor* _sender, ClutterEvent* event, gpointer self) {
	gboolean result;
	result = _unity_launcher_quicklist_image_menu_item_on_mouse_down (self, event);
	return result;
}
...
static gboolean _unity_launcher_quicklist_image_menu_item_on_mouse_down (UnityLauncherQuicklistImageMenuItem* self, ClutterEvent* event) {
	...
	g_signal_handlers_disconnect_matched ((GObject*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_DETAIL | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp0_, _tmp1_, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_label_changed_g_object_notify, self);
	g_signal_parse_name ("enter-event", CLUTTER_TYPE_ACTOR, &_tmp2_, NULL, FALSE);
	g_signal_handlers_disconnect_matched ((ClutterActor*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp2_, 0, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_enter_clutter_actor_enter_event, self);
	g_signal_parse_name ("leave-event", CLUTTER_TYPE_ACTOR, &_tmp3_, NULL, FALSE);
	g_signal_handlers_disconnect_matched ((ClutterActor*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp3_, 0, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_leave_clutter_actor_leave_event, self);
	g_signal_parse_name ("button-press-event", CLUTTER_TYPE_ACTOR, &_tmp4_, NULL, FALSE);
	g_signal_handlers_disconnect_matched ((ClutterActor*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp4_, 0, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_mouse_down_clutter_actor_button_press_event, self);
...
UnityLauncherQuicklistImageMenuItem* unity_launcher_quicklist_image_menu_item_construct (GType object_type) {
	UnityLauncherQuicklistImageMenuItem * self;
	self = (UnityLauncherQuicklistImageMenuItem*) g_object_new (object_type, "label", "", NULL);
	return self;
}


UnityLauncherQuicklistImageMenuItem* unity_launcher_quicklist_image_menu_item_new (void) {
	return unity_launcher_quicklist_image_menu_item_construct (UNITY_LAUNCHER_TYPE_QUICKLIST_IMAGE_MENU_ITEM);
}
...
UnityLauncherQuicklistImageMenuItem* unity_launcher_quicklist_image_menu_item_construct_with_label (GType object_type, const char* label) {
	...
	self = (UnityLauncherQuicklistImageMenuItem*) g_object_new (object_type, "label", label, NULL);
	return self;
}


UnityLauncherQuicklistImageMenuItem* unity_launcher_quicklist_image_menu_item_new_with_label (const char* label) {
	return unity_launcher_quicklist_image_menu_item_construct_with_label (UNITY_LAUNCHER_TYPE_QUICKLIST_IMAGE_MENU_ITEM, label);
}
...
static GObject * unity_launcher_quicklist_image_menu_item_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	UnityLauncherQuicklistImageMenuItem * self;
	parent_class = G_OBJECT_CLASS (unity_launcher_quicklist_image_menu_item_parent_class);
	...
	self = UNITY_LAUNCHER_QUICKLIST_IMAGE_MENU_ITEM (obj);
	{
		...
		g_signal_connect_object ((GObject*) self, "notify::label", (GCallback) __unity_launcher_quicklist_image_menu_item_on_label_changed_g_object_notify, self, 0);
		g_signal_connect_object ((ClutterActor*) self, "enter-event", (GCallback) __unity_launcher_quicklist_image_menu_item_on_enter_clutter_actor_enter_event, self, 0);
		g_signal_connect_object ((ClutterActor*) self, "leave-event", (GCallback) __unity_launcher_quicklist_image_menu_item_on_leave_clutter_actor_leave_event, self, 0);
		g_signal_connect_object ((ClutterActor*) self, "button-press-event", (GCallback) __unity_launcher_quicklist_image_menu_item_on_mouse_down_clutter_actor_button_press_event, self, 0);
...
static void unity_launcher_quicklist_image_menu_item_class_init (UnityLauncherQuicklistImageMenuItemClass * klass) {
	unity_launcher_quicklist_image_menu_item_parent_class = g_type_class_peek_parent (klass);
	g_type_class_add_private (klass, sizeof (UnityLauncherQuicklistImageMenuItemPrivate));
	CLUTTER_ACTOR_CLASS (klass)->paint = unity_launcher_quicklist_image_menu_item_real_paint;
	CLUTTER_ACTOR_CLASS (klass)->get_preferred_height = unity_launcher_quicklist_image_menu_item_real_get_preferred_height;
	CLUTTER_ACTOR_CLASS (klass)->get_preferred_width = unity_launcher_quicklist_image_menu_item_real_get_preferred_width;
	CLUTTER_ACTOR_CLASS (klass)->allocate = unity_launcher_quicklist_image_menu_item_real_allocate;
	G_OBJECT_CLASS (klass)->constructor = unity_launcher_quicklist_image_menu_item_constructor;
	G_OBJECT_CLASS (klass)->finalize = unity_launcher_quicklist_image_menu_item_finalize;
}


static void unity_launcher_quicklist_image_menu_item_instance_init (UnityLauncherQuicklistImageMenuItem * self) {
	self->priv = UNITY_LAUNCHER_QUICKLIST_IMAGE_MENU_ITEM_GET_PRIVATE (self);
}
...
static void unity_launcher_quicklist_image_menu_item_finalize (GObject* obj) {
	...
	self = UNITY_LAUNCHER_QUICKLIST_IMAGE_MENU_ITEM (obj);
	{
		...
		g_signal_handlers_disconnect_matched ((GObject*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_DETAIL | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp2_, _tmp3_, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_label_changed_g_object_notify, self);
		g_signal_parse_name ("enter-event", CLUTTER_TYPE_ACTOR, &_tmp4_, NULL, FALSE);
		g_signal_handlers_disconnect_matched ((ClutterActor*) self, G_SIGNAL_MATCH_ID | G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA, _tmp4_, 0, NULL, (GCallback) __unity_launcher_quicklist_image_menu_item_on_enter_clutter_actor_enter_event, self);
	...
	G_OBJECT_CLASS (unity_launcher_quicklist_image_menu_item_parent_class)->finalize (obj);
}


GType unity_launcher_quicklist_image_menu_item_get_type (void) {
	static volatile gsize unity_launcher_quicklist_image_menu_item_type_id__volatile = 0;
	if (g_once_init_enter (&unity_launcher_quicklist_image_menu_item_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (UnityLauncherQuicklistImageMenuItemClass), (GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL, (GClassInitFunc) unity_launcher_quicklist_image_menu_item_class_init, (GClassFinalizeFunc) NULL, NULL, sizeof (UnityLauncherQuicklistImageMenuItem), 0, (GInstanceInitFunc) unity_launcher_quicklist_image_menu_item_instance_init, NULL };
		GType unity_launcher_quicklist_image_menu_item_type_id;
		unity_launcher_quicklist_image_menu_item_type_id = g_type_register_static (CTK_TYPE_IMAGE_MENU_ITEM, "UnityLauncherQuicklistImageMenuItem", &g_define_type_info, 0);
		g_once_init_leave (&unity_launcher_quicklist_image_menu_item_type_id__volatile, unity_launcher_quicklist_image_menu_item_type_id);
	}
	return unity_launcher_quicklist_image_menu_item_type_id__volatile;
}
