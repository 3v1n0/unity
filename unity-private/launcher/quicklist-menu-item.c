/* quicklist-menu-item.c generated by valac 0.9.7, the Vala compiler
...
static void unity_launcher_quicklist_menu_item_real_get_preferred_width (ClutterActor* base, float for_height, float* min_width_p, float* natural_width_p) {
	...
	_g_free0 (_tmp1_);
	*min_width_p = (((float) width) + ((float) ctk_em_to_pixel ((double) (2 * UNITY_LAUNCHER_MARGIN)))) + (2 * UNITY_LAUNCHER_ITEM_INDENT_ABS);
