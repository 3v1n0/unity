/* panel-window-buttons.c generated by valac 0.9.5, the Vala compiler
...
static GObject * unity_panel_window_button_constructor (GType type, guint n_construct_properties, GObjectConstructParam * construct_properties) {
	...
	_inner_error_ = NULL;
	{
		...
		__catch12_g_error:
		{
			...
			{
				char* _tmp18_;
				g_warning ("panel-window-buttons.vala:217: %s", _tmp18_ = g_strconcat ("Unable to load window button theme: You need Ambiance installed: ", string_to_string (e->message), NULL));
				_g_free0 (_tmp18_);
				_g_error_free0 (e);
			}
		}
