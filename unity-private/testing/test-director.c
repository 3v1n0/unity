...
static gboolean _lambda66_ (UnityTestingDirector* self);
...
void unity_testing_director_do_wait_for_timeout (UnityTestingDirector* self, guint32 msecs) {
	...
	g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) msecs, __lambda66__gsource_func, g_object_ref (self), g_object_unref);
	while (TRUE) {
