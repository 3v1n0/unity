...
static gboolean _lambda65_ (UnityTestingDirector* self);
...
void unity_testing_director_do_wait_for_timeout (UnityTestingDirector* self, guint32 msecs) {
	...
	g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) msecs, __lambda65__gsource_func, g_object_ref (self), g_object_unref);
	while (TRUE) {
