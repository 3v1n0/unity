/* background.c generated by valac 0.9.5, the Vala compiler
...
static gboolean _lambda78_ (UnityTestingBackground* self);
static gboolean __lambda78__gsource_func (gpointer self);
...
static void _unity_testing_background_on_allocation_changed (UnityTestingBackground* self) {
	g_return_if_fail (self != NULL);
	g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 0, __lambda78__gsource_func, g_object_ref (self), g_object_unref);
}
