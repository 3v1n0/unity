/* shell.c generated by valac 0.9.7, the Vala compiler
...
gboolean unity_shell_get_is_starting (UnityShell* self) {
	return UNITY_SHELL_GET_INTERFACE (self)->get_is_starting (self);
}


void unity_shell_set_is_starting (UnityShell* self, gboolean value) {
	UNITY_SHELL_GET_INTERFACE (self)->set_is_starting (self, value);
}
...
static void unity_shell_base_init (UnityShellIface * iface) {
	...
	if (!initialized) {
		...
		g_object_interface_install_property (iface, g_param_spec_boolean ("is-starting", "is-starting", "is-starting", FALSE, G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB | G_PARAM_READABLE | G_PARAM_WRITABLE));
