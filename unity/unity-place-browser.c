/* unity-place-browser.c generated by valac 0.9.5, the Vala compiler
...
static UnityPlace_BrowsingState* unity_place_browser_service_impl_real_go_back (UnityPlaceBrowserService* base, int* result_length1, GError** error) {
	...
	result = (_tmp3_ = (_tmp2_ = unity_place_browser_service_impl_get_browsing_state (self, &_tmp0_), (_tmp2_ == NULL) ? ((gpointer) _tmp2_) : _vala_array_dup8 (_tmp2_, _tmp0_)), *result_length1 = _tmp0_, _tmp3_);
	return result;
}
